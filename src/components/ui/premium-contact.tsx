...
const contactMethods = [
  {
    ...
    value: "0501saurav@gmail.com",
    link: "mailto:0501saurav@gmail.com",
  ...
  },
  {
    ...
    link: "https://cal.com/saurav-kumar-uyq5iq",
  ...
  },
  {
    ...
    value: "House no. 80, Sector 28, Faridabad",
    link: "https://www.google.com/maps/search/?api=1&query=House+no.+80+Sector+28+HBH+Colony+faridabad",
...
export function PremiumContact() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!serviceId || !templateId || !publicKey) {
        ...
        // Handle error for user, e.g., set an error state
